...
setwd("/Users/nachernev/Desktop/OAD/lab11(R)/part_1")
...
population <- read.table("data/Population.txt",
                         header = TRUE,
                         sep = "\t")
...
subset80 <- subset(data, weight <= 80)
subset80

length(subset80$weight[subset80$weight > 80])
