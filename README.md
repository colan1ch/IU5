...
- [Практика — TO-DO-List](Сем2/ПКШ/Практика) — графическое приложение для работы со списком задач.

## Семестр 3

### ПИКЯП — Парадигмы и конструкции языков программирования

- [Материалы по ПИКЯП](Сем3/Пикяп)
- [Модели данных](Сем3/Модели%20данных)
- [Репозиторий PCPL на GitHub](https://github.com/colan1ch/PCPL)

## Семестр 4

### XML — Программирование сетевых приложений

- [Лабораторные работы](Сем4/XML)
- [Репозиторий XML_LW на GitHub](https://github.com/colan1ch/XML_LW)

### Базы данных

- [Лабораторные работы и материалы](Сем4/Базы%20данных)
- [Курсовая работа — FootballClubs](Сем4/Базы%20данных/Курсовая/FootballClubs) — приложение для работы с базой данных футбольных клубов.
- [Репозиторий FootballClubs на GitHub](https://github.com/colan1ch/FootballClubs)
...
- [Домашнее задание — affinity-analysis_IU5-54B](Сем5/ОАД/ДЗ/affinity-analysis_IU5-54B) — анализ совместных покупок и взаимосвязей между товарами.
- [Репозиторий affinity-analysis_IU5-54B на GitHub](https://github.com/colan1ch/affinity-analysis_IU5-54B)
